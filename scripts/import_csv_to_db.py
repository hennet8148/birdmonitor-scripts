...
# Config
CSV_FOLDER = '/Users/chuck/BirdMonitor/data/unprocessed_csv'
PROCESSED_CSV_FOLDER = '/Users/chuck/BirdMonitor/data/processed_csv'

# Load DB credentials from external file
...
def infer_location(wav_filename):
    if wav_filename.startswith("S2_"):
        return "S2"
    else:
        return "S1"
...
def insert_sighting(cursor, row):
    ...
    location = infer_location(wav_filename)
